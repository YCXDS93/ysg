...
public class Bean {
    ...
    public String msg;
    @SerializedName("[]")
    public List<ysgBean> ysg;

    public static class ysgBean {
        /**
        ...
        public List<CommentysgBean> Commentysg;
        ...
        public static class CommentysgBean {
            /**
             * id : 3
             * toId : 0
             * userId : 82002
